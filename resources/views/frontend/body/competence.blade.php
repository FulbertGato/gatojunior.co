								...
								<div class="tab-data-cont">
									<div class="row justify-content-center">
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/apple.svg')}}"
															alt="Apple"> </div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/android.svg')}}"
															alt="Android"> </div>
													<div class="iwt-content">
														<p>Android</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/flutterio-icon.svg')}}"
															alt="Flutter"> </div>
													<div class="iwt-content">
														<p>Flutter</p>
													</div>
								...
								<div class="tab-data-cont">
									<div class="row justify-content-center">
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/angular.svg')}}"
															alt="Angular.JS"> </div>
													<div class="iwt-content">
														<p>Angular.JS</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/html-5.svg')}}"
															alt="html-5"> </div>
													<div class="iwt-content">
														<p>HTML5</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/vuejs.svg')}}"
															alt="vuejs"> </div>
													<div class="iwt-content">
														<p>Vue JS</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/bootstrap.svg')}}"
															alt="bootstrap"> </div>
													<div class="iwt-content">
														<p>Bootstrap</p>
													</div>
								...
								<div class="tab-data-cont">
									<div class="row justify-content-center">
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/mongodb-icon.svg')}}"
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/mysql.svg')}}"
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/oracle.svg')}}"
															alt="oracle-logo"> </div>
													<div class="iwt-content">
														<p>Oracle</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/sqlite.svg')}}"
															alt="sqlite"> </div>
													<div class="iwt-content">
														<p>Sqlite</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/aws-rds.svg')}}"
															alt="aws-rds"> </div>
													<div class="iwt-content">
														<p>AWS-RDS</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/microsoft-access.svg')}}"
								...
								<div class="tab-data-cont">
									<div class="row justify-content-center">
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/shopify.svg')}}"
															alt="shopify"> </div>
													<div class="iwt-content">
														<p>Shopify</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/magento.svg')}}"
															alt="magento"> </div>
													<div class="iwt-content">
														<p>Magento</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/wordpress.svg')}}"
															alt="wordpress"> </div>
													<div class="iwt-content">
														<p>Wordpress</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/joomla.svg')}}"
															alt="joomla"> </div>
													<div class="iwt-content">
														<p>Joomla</p>
													</div>
										...
										<div class="col-lg-2 col-md-3 col-sm-4 col-6">
											<div class="icon-with-title">
												<a href="javascript:void(0)">
													<div class="iwt-icon"> <img src="{{asset('frontend/images/icons/drupal.svg')}}"
															alt="drupal"> </div>
													<div class="iwt-content">
														<p>Drupal</p>
													</div>

    ...
    <div class="container-fluid m-p-l-r-0">
        <div class="menu-header">
            ...
            <div class="ree-nav" role="navigation">
                <ul class="nav-list">
                    <li><a href="{{env('APP_URL')}}#home" class="menu-links">Home</a></li>
                    <li><a href="{{env('APP_URL')}}#service" class="menu-links">Services</a></li>
                    <li><a href="{{env('APP_URL')}}#work" class="menu-links">Our Work</a></li>
                    <li><a href="{{env('APP_URL')}}#review" class="menu-links">Clients Review</a></li>
                    <li><a href="{{env('APP_URL')}}#about" class="menu-links">About</a></li>
                    <li><a href="{{env('APP_URL')}}#contact" class="menu-links">Contact</a></li>
                </ul>
            </div>
            <div class="ree-nav-cta">
                <ul>
                    <li><a href="{{env('APP_URL')}}/quote" class="ree-btn ree-btn0 ree-btn-grdt2"> Request Quote</a> </li>
                </ul>
            </div>
            ...
            <nav id="main-nav">
                ...
                <ul class="bottom-nav">
                    <li class="ree-hc">
                        <a href="tel:123567890" rel="noreferrer" target="_blank"> <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 25.625 25.625" style="enable-background:new 0 0 25.625 25.625;" xml:space="preserve">
